...
export const productThumbnailFrameClass =
  `relative w-full overflow-hidden bg-muted ${PRODUCT_THUMB_ASPECT_CLASS}`;
...
export const productThumbnailImageHoverClass =
  `${productThumbnailImageClass} hover:scale-[1.02] hover:opacity-90`;
